...
var OPTIONS = {
  "config": ["c", "Custom configuration file", "string"],
  "reporter": ["reporter", "Custom reporter (<PATH>|jslint|checkstyle|unix)", "string"],
  "prereq": [
    "prereq",
  ...
  "exclude": ["exclude",
    "Exclude files matching the given filename pattern (same as .jshintignore)", "string"],
  "exclude-path": ["exclude-path", "Pass in a custom jshintignore file path", "string"],
  "verbose": ["verbose", "Show message codes", "boolean"],
  "show-non-errors": ["show-non-errors", "Show additional data generated by jshint", "boolean"],
  "extra-ext": ["e",
    "Comma-separated list of file extensions to use (default is .js)", "string", ""],

  "extract": [
    "extract",
    "Extract inline scripts contained in HTML (auto|always|never)",
    "string",
    "never"
  ],
};
...
var exports = {
  ...
  loadConfig: function(fp) {
    ...
    if (!fsUtils.exists(fp)) {
      console.error("Can't find config file: " + fp);
      exports.exit(1);
    }
    ...
    try {
      ...
      console.error("Can't parse config file: " + fp + "\nError:" + err);
      exports.exit(1);
    }
  },
  ...
  interpret: function(args) {
    var cli = optymista(args.slice(2));
    Object.entries(OPTIONS).forEach(function(entry) {
      ...
      cli.option(entry[0], opt);
    });
    cli.version(require('../package.json').version);

    var options = cli.argv;
    ...
    if (options.reporter) {
      ...
      if (reporter === null) {
        console.error("Can't load reporter file: " + options.reporter);
        exports.exit(1);
      }
    }
